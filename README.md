...
![](https://github.com/MutazAlabdulkarim/BOTTFN/blob/main/public/config/images/logo.png)
...
```sh
git clone https://github.com/MutazAlabdulkarim/BOTTFN.git
```
...
```json
{
  ...
  "SYMBOL": "BF",
  "MAX_SUPPLY": 4099,
  "WEI_COST": 119000000000000000000,
  "DISPLAY_COST": 119,
  "GAS_LIMIT": 285000,
  "MARKETPLACE": "Opeansea",
  "MARKETPLACE_LINK": "https://opensea.io/collection/bottfn",
